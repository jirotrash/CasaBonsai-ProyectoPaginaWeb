...
try{
		...
		$stmt->execute([':c1' => 'Tecnología', ':c2' => 'Tecnologia', ':slug' => 'tecnologia']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Teléfono Fijo con Teclas Grandes','descripcion'=>'Teléfono con teclas grandes y función tecla de emergencia.','precio'=>'950','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Reloj Localizador para Personas','descripcion'=>'Reloj con GPS y botón de ayuda para emergencias.','precio'=>'1850','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Radio Portátil de Fácil Uso','descripcion'=>'Radio con botones grandes y control de volumen controlable.','precio'=>'420','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Lupa Electrónica Portátil','descripcion'=>'Lupa con luz integrada y ajuste de zoom para facilitar la lectura.','precio'=>'1290','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Tecnología - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Tecnología accesible: dispositivos pensados para facilitar la comunicación y seguridad de adultos mayores.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Tecnología</h1>
			<p class="lead">Dispositivos y soluciones tecnológicas accesibles para apoyar la comunicación y seguridad.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Tecnología">
