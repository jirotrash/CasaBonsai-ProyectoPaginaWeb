...
try{
		...
		$stmt->execute([':c1' => 'Higiene', ':c2' => 'Higiene', ':slug' => 'higiene']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Gel Antibacterial Suave','descripcion'=>'Gel sin alcohol agresivo, apto para piel sensible.','precio'=>'75','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Champú Suave para Piel Sensible','descripcion'=>'Fórmula sin sulfatos, ideal para cueros cabelludos delicados.','precio'=>'110','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Cepillo Dental de Cerdas Blandas','descripcion'=>'Cerdas suaves y mango ergonómico para facilitar el cepillado.','precio'=>'55','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Toallas Húmedas Hipoalergénicas','descripcion'=>'Toallitas suaves para higiene diaria, sin fragancias.','precio'=>'130','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Higiene - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos de higiene pensados para adultos mayores: suaves, hipoalergénicos y fáciles de usar.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Higiene</h1>
			<p class="lead">Productos de higiene adaptados: suaves, hipoalergénicos y fáciles de usar para adultos mayores.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Higiene">
