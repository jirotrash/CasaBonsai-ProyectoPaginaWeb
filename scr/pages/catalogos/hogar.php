...
try{
		...
		$stmt->execute([':c1' => 'Hogar', ':c2' => 'Hogar', ':slug' => 'hogar']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Almohada Ortopédica','descripcion'=>'Almohada de soporte para mayor confort y alineación cervical.','precio'=>'420','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Colchón Anti-úlceras (funda lavable)','descripcion'=>'Capa de alivio de presión para uso prolongado en cama.','precio'=>'3500','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Asiento Elevador para WC','descripcion'=>'Asiento ergonómico que facilita levantarse y sentarse en el baño.','precio'=>'980','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Lámpara de lectura con brazo flexible','descripcion'=>'Iluminación dirigida para lectura y actividades manuales, con control fácil.','precio'=>'250','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Hogar - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos para el hogar pensados para la seguridad y confort de adultos mayores.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Hogar</h1>
			<p class="lead">Accesorios y soluciones para mejorar la seguridad y confort en el hogar.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Hogar">
