...
try{
		...
		$stmt->execute([':c1' => 'Seguridad', ':c2' => 'Seguridad', ':slug' => 'seguridad']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Barandilla de Seguridad para Cama','descripcion'=>'Barandilla lateral para evitar caídas y facilitar movilidad en la cama.','precio'=>'760','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Alarma Personal de Emergencia','descripcion'=>'Botón de emergencia con cuerda o colgante para solicitar ayuda inmediata.','precio'=>'550','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Tapete Antideslizante para Baño','descripcion'=>'Tapete con succión fuerte para evitar resbalones dentro de la ducha.','precio'=>'120','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Sensor de Caídas (colocable)','descripcion'=>'Detector de caídas con alarma sonora para uso doméstico.','precio'=>'1350','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Seguridad - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos para la seguridad en el hogar: prevención de caídas y ayuda en emergencias.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Seguridad</h1>
			<p class="lead">Productos para prevenir caídas y responder en situaciones de emergencia.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Seguridad">
