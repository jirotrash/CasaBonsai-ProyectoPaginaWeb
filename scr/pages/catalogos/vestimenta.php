...
try{
		...
		$stmt->execute([':c1' => 'Vestimenta', ':c2' => 'Vestimenta', ':slug' => 'vestimenta']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Bata cómoda con botones frontales','descripcion'=>'Bata de material suave y botones grandes para facilitar el vestido.','precio'=>'320','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Pantalón elástico fácil de poner','descripcion'=>'Pantalón con cintura elástica para mayor comodidad y facilidad de uso.','precio'=>'210','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Zapatos con cierre velcro','descripcion'=>'Calzado cómodo con cierre de velcro para mayor seguridad y ajuste.','precio'=>'450','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Chaleco térmico ligero','descripcion'=>'Prenda térmica para mantener calor sin peso extra, fácil de poner.','precio'=>'280','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Vestimenta - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Ropa y accesorios adaptados para adultos mayores: comodidad y facilidad de uso.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Vestimenta</h1>
			<p class="lead">Ropa y calzado adaptado para mayor comodidad, seguridad y facilidad de uso.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Vestimenta">
