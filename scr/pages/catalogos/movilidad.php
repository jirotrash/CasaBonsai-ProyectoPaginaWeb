...
try{
		...
		$stmt->execute([':c1' => 'Movilidad', ':c2' => 'Movilidad', ':slug' => 'movilidad']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Andador Plegable','descripcion'=>'Andador ligero y plegable con frenos fáciles de usar.','precio'=>'850','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Bastón con Base Ancha','descripcion'=>'Bastón estable con base de tres puntas para mayor equilibrio.','precio'=>'220','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Silla de Ruedas Manual','descripcion'=>'Silla resistente, plegable para transporte y almacenaje sencillo.','precio'=>'4200','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Muletas Ajustables','descripcion'=>'Muletas con empuñadura ergonómica y ajuste de altura.','precio'=>'480','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Movilidad - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos de movilidad: ayudas para caminar, andadores, bastones y sillas de ruedas.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Movilidad</h1>
			<p class="lead">Ayudas de movilidad para mantener independencia y seguridad en la movilidad diaria.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Movilidad">
