...
try{
		...
		$stmt->execute([':c1' => 'Rehabilitación', ':c2' => 'Rehabilitacion', ':slug' => 'rehabilitacion']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Banda Elástica de Ejercicio','descripcion'=>'Bandas para ejercicios de resistencia y rehabilitación en casa.','precio'=>'95','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Pelota de Ejercicio Mediana','descripcion'=>'Pelota para ejercicios de equilibrio y fisioterapia.','precio'=>'140','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Kit de Terapia de Mano','descripcion'=>'Herramientas para recuperar movilidad y fuerza de manos y dedos.','precio'=>'210','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Mini Bicicleta Estática','descripcion'=>'Pedalier para ejercicios suaves de piernas y brazos, ideal para recuperación.','precio'=>'650','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Rehabilitación - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos para rehabilitación: herramientas y ayudas para recuperación de movilidad y fuerza.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			...
			<p class="lead">Herramientas y recursos para apoyar la recuperación física y el fortalecimiento.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Rehabilitación">
