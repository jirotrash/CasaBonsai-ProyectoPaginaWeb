...
try{
		...
		$stmt->execute([':c1' => 'Cuidado Personal', ':c2' => 'Cuidado-personal', ':slug' => 'cuidado-personal']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Crema Hidratante Suave','descripcion'=>'Crema sin fragancia, texturas suaves e hidratación prolongada para piel sensible.','precio'=>'95','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Cepillo de Dientes de Mango Largo','descripcion'=>'Mango ergonómico para facilitar la higiene bucal en personas con movilidad reducida.','precio'=>'70','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Toallas Húmedas Suaves','descripcion'=>'Toallitas humedecidas, pH neutro, presentación económica para uso diario.','precio'=>'120','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Jabón Líquido Suave','descripcion'=>'Jabón líquido sin sulfatos, ideal para piel sensible.','precio'=>'85','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Cuidado Personal - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos de cuidado personal pensados para adultos mayores: higiene suave y accesorios ergonómicos.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			...
			<p class="lead">Higiene y productos ergonómicos pensados para el bienestar y la comodidad de adultos mayores.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Cuidado Personal">
