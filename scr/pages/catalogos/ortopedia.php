...
try{
		...
		$stmt->execute([':c1' => 'Ortopedia', ':c2' => 'Ortopedia', ':slug' => 'ortopedia']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Férula de muñeca ajustable','descripcion'=>'Soporte para inmovilización suave, con ajuste fácil y acolchado.','precio'=>'320','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Rodillera con refuerzo','descripcion'=>'Rodillera estabilizadora para apoyo en movilidad y ejercicio leve.','precio'=>'480','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Soporte lumbar con velcro','descripcion'=>'Cinturón lumbar para soporte en actividades diarias y alivio de molestias.','precio'=>'390','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Plantillas ortopédicas','descripcion'=>'Plantillas de apoyo para pie con soporte de arco y amortiguación.','precio'=>'220','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Ortopedia - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos ortopédicos: soportes, plantillas y ayudas para mejorar la calidad de movimiento.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Ortopedia</h1>
			<p class="lead">Soportes ortopédicos y ayudas para mejorar la movilidad y confort.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Ortopedia">
