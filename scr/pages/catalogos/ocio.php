...
try{
		...
		$stmt->execute([':c1' => 'Ocio', ':c2' => 'Ocio', ':slug' => 'ocio']);
...
if (empty($productos)){
		$productos = [
				['nombre'=>'Juegos de Mesa Adaptados','descripcion'=>'Juegos con piezas grandes y reglas simplificadas para reuniones sociales.','precio'=>'220','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Kit de Manualidades','descripcion'=>'Materiales para manualidades: papeles, pinceles y guías para actividades creativas.','precio'=>'180','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Puzzles Grandes','descripcion'=>'Puzzles con piezas grandes y estampas contrastadas para mayor visibilidad.','precio'=>'140','imagen'=>'/casabonsai/scr/resources/images/placeholder.png'],
				['nombre'=>'Kit de Jardinería Pasiva','descripcion'=>'Pequeñas macetas, semillas y herramientas de agarre sencillo para jardinería en casa.','precio'=>'175','imagen'=>'/casabonsai/scr/resources/images/placeholder.png']
		];
}
...
<head>
	...
	<title>Ocio - Casa Bonsái</title>
	<link rel="stylesheet" href="../../styles/styles.css">
	<meta name="description" content="Productos y actividades de ocio para adultos mayores: estimulación, entretenimiento y socialización.">
</head>
<body>
	...
	<header class="page-hero page-hero--small">
		<div class="container">
			<h1>Ocio</h1>
			<p class="lead">Actividades y productos para estimular la mente, la creatividad y la socialización.</p>
		</div>
	</header>
	...
	<main class="container">
		<section class="products-grid" aria-label="Ocio">
