...
<body>
	...
	<div class="container"><div class="card"><h1>Administrar Usuario_Rol</h1><p>Tabla: <strong><?php echo $table; ?></strong></p><p>Ir al gestor: <a href="<?php echo htmlspecialchars(
